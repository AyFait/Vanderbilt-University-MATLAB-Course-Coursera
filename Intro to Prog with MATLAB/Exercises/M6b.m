...
The function takes two positive scalars called v and q as input and returns the logical admit as output. 
...
% percentiles = ((v+q)/2 >= 92) && (v && q > 88); wrong!
percentiles = ((v+q)/2 >= 92) && ((v > 88) && (q > 88));
